...
RESOURCE = os.environ.get(
    ...
    "projects/210430842247/locations/us-east1/reasoningEngines/8622095307112448000",
)
...
def _extract_parts(parts: list) -> list[dict]:
    ...
    for p in parts:
        ...
        if isinstance(root, TextPart) and getattr(root, "text", None):
            ...
            if not meta and isinstance(data_obj, dict):
            ...
            if mime == _A2UI_MIME:
                ...
                "beginRendering" in data_obj or "surfaceUpdate" in data_obj
            ):
